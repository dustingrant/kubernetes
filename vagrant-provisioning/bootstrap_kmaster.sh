...
kubeadm init --apiserver-advertise-address=10.0.0.220 --pod-network-cidr=192.168.0.0/16 >> /root/kubeinit.log 2>/dev/null
...
echo "[TASK 5] Copy Kube Config to vagrant user directory"
